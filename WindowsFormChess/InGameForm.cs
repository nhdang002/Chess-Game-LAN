...
namespace Sakk_Alkalmazás_2._0
{
    public partial class InGameForm : Form
    {
        ...
        private void SendMove(int i, int j)
        {
            ...
            //0 loai du lieu
            byte[] datas = {0,  (byte)LastMovedPiece, (byte)BeforeMove_I, (byte)BeforeMove_J, (byte)i, (byte)j, (byte)Moves, (byte)Castling, (byte)Promotionvalue };
        ...
        {
            MessageBox.Show("Gui yeu cau undo");
            byte[] data = { 1 };
            sock.Send(data);
        }
